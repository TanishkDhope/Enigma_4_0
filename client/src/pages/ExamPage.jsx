...
const ExamPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 text-white flex flex-col md:flex-row p-6">
      {/* Side Panel */}
      ...
      <div className="w-full md:w-3/4 bg-white text-gray-900 rounded-lg shadow-xl p-8 flex flex-col items-center justify-between">
        {showScore ? (
          <div className="text-center">
            <h2 className="text-4xl font-bold mb-6 text-blue-600">Exam Completed</h2>
          ...
          <>
            ...
            <div className="question-container w-full mb-2 mt-24">
              ...
              <p className="text-xl mb-4 text-gray-700">{questions[currentQuestion].question}</p>
